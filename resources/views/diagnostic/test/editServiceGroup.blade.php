    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{route('update-serviceGroup.post')}}" id="myForm"
                              method="post" accept-charset="utf-8">
                            <!-- SmartWizard html -->

                            {{csrf_field()}}

                            <input type="hidden" name="service_group_id" value="{{$serviceGroup->service_group_id}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        {!! Form::select('service_category_id',
                                                  $service_categories
                                                  ,$serviceGroup->service_category_id, ['class'=> 'form-control','placeholder'=>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        {!! Form::select('service_sub_category_id',
                                                  ...
                                                  ,$serviceGroup->service_sub_category_id!=null?$serviceGroup->service_sub_category_id:null, ['class'=> 'form-control','placeholder'=>
                                            ...
                                            @if(count($services) > 0)
                                                <div>
                                                    ...
                                                    @foreach($services as $key => $service)
                                                        ...
                                                        <div class="row">
                                                            <label for="diagnostic_test_name" class="col-md-1"></label>
                                                            <input type="hidden" name="diagnostic_test_id[]"
                                                                   value="{{$service->diagnostic_test_id}}">
                                                            <div class="col-md-2">
