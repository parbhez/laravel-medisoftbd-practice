        ...
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <form action="{{route('hr.update-schedule.post')}}" id="myForm" role="form" data-toggle="validator"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    ,$schedule->schedule_date, ['class'=> 'form-control','placeholder'=>
                                    ...
                                    <table class="table table-hover" id="firstTable">
                                        <tbody>
                                            ...
                                            <tr class="row_to_clone_first">
                                                ...
                                                <td>
                                                    <input name="start_time[{{$i}}]" type="text" value="{{$slot->start_time}}"
                                                        class="bootstrap-timepicker form-control timepicker" />

                                                    <input type="hidden" name="schedule_slot_id[{{$i}}]" value="{{$slot->schedule_slot_id}}">
                                                </td>

                                                <td>
                                                    <input name="end_time[{{$i}}]" type="text" value="{{$slot->end_time}}"
                                                        class="bootstrap-timepicker form-control timepicker" />
                                                </td>

                                                <td>
                                                    <input name="visitor_limit[{{$i}}]" type="text" value="{{$slot->visitor_limit}}"
                                                        class="form-control" />
                                                </td>
